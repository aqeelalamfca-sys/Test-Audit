    ...
    <div className="flex flex-col gap-4 p-4 max-w-5xl mx-auto" data-testid="compliance-simulation-page">
      <div className="flex items-center justify-between gap-2 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-semibold" data-testid="text-page-title">Compliance Simulation</h1>
        </div>
        <Button
              ...
              <AccordionItem value={`section-${i}`} key={i} data-testid={`section-${section.name.replace(/\s+/g, "-").toLowerCase()}-${i}`}>
                ...
                <AccordionContent className="px-2">
                  {section.status === "ERROR" ? (
                    <p className="text-sm text-orange-600 dark:text-orange-400 py-2" data-testid={`text-error-${i}`}>
                      {section.error || "A database error occurred during this check. Results may be incomplete."}
                    </p>
