...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    data-slot="tabs-list"
    className={cn(
      "inline-flex items-center gap-0.5 rounded-lg bg-muted/50 p-1 text-muted-foreground border border-border/40 w-full overflow-x-auto scrollbar-none",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md px-3 py-1.5 text-xs font-medium transition-all shrink-0",
