...
const ROLE_THEMES: Record<RoleThemeKey, RoleThemeConfig> = {
  ...
  orange: {
    ...
    sidebarBorderDark: "dark:border-emerald-900",
    sidebarHeaderBg: "bg-emerald-50/50",
    sidebarHeaderBgDark: "dark:bg-emerald-950/30",
    iconColor: "text-emerald-700",
    iconColorDark: "dark:text-emerald-400",
    activeItemBg: "data-[active=true]:bg-emerald-100",
    activeItemText: "data-[active=true]:text-emerald-800",
    activeItemBgDark: "dark:data-[active=true]:bg-emerald-950",
    activeItemTextDark: "dark:data-[active=true]:text-emerald-300",
    hoverBg: "hover:bg-emerald-50",
    hoverBgDark: "dark:hover:bg-emerald-950/50",
    hoverText: "hover:text-emerald-700",
    hoverTextDark: "dark:hover:text-emerald-400",
    groupLabelColor: "text-emerald-700",
    groupLabelColorDark: "dark:text-emerald-400",
    badgeBg: "bg-emerald-100",
    badgeText: "text-emerald-800",
    badgeBgDark: "dark:bg-emerald-950",
...
export function getRoleDisplayLabel(role: string | undefined | null): string {
  ...
  const labels: Record<string, string> = {
    ...
    eqcr: "Engagement Quality Reviewer",
    manager: "Manager",
    senior: "Senior",
    staff: "Audit Team",
    read_only: "Read Only",
