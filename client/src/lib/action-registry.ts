...
const ROUTE_CONFIGS: RouteActionConfig[] = [
  {
    ...
    backHref: () => DASHBOARD,
    nextHref: (id) => `/workspace/${id}/pre-planning`,
  ...
  {
    route: "/workspace/:id/pre-planning",
    label: "Pre-Planning",
    phase: "pre-planning",
    backHref: (id) => `/workspace/${id}/requisition`,
    nextHref: (id) => `/workspace/${id}/planning`,
    dashboardHref: () => DASHBOARD,
    coreActions: ALL_CORE_ENABLED,
    contextualActions: [],
    maxCoreActions: 4,
  ...
  },
  {
    ...
    label: "Planning",
    phase: "planning",
    backHref: (id) => `/workspace/${id}/pre-planning`,
    nextHref: (id) => `/workspace/${id}/execution`,
    dashboardHref: () => DASHBOARD,
    coreActions: ALL_CORE_ENABLED,
    contextualActions: [
      {
