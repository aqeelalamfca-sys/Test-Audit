...
const RBAC_MATRIX_DATA = {
  roleHierarchy: [
    ...
    { level: 3, role: "TEAM_LEAD", description: "Team lead, execution oversight" },
    { level: 4, role: "MANAGER", description: "Engagement manager, review authority" },
    { level: 5, role: "MANAGING_PARTNER", description: "Managing partner" },
    { level: 5, role: "PARTNER", description: "Engagement partner, approval authority" },
    { level: 6, role: "EQCR", description: "Engagement quality control reviewer" },
    { level: 7, role: "ADMIN", description: "Firm administrator" },
    { level: 8, role: "FIRM_ADMIN", description: "Firm-level administrator" },
    { level: 99, role: "SUPER_ADMIN", description: "Platform administrator (no firm data access)" },
  ],
  permissions: {
    engagementManagement: {
      viewEngagements: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: true, FIRM_ADMIN: true, SUPER_ADMIN: false },
      createEngagement: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: true, PARTNER: true, EQCR: false, FIRM_ADMIN: true, SUPER_ADMIN: false },
      editEngagement: { STAFF: false, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false, FIRM_ADMIN: true, SUPER_ADMIN: false },
      deleteEngagement: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: true, EQCR: false, FIRM_ADMIN: true, SUPER_ADMIN: false },
      lockArchive: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: true, EQCR: false, FIRM_ADMIN: false, SUPER_ADMIN: false },
    },
    signOffAuthority: {
      prepare: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: false, PARTNER: false, EQCR: false },
      review: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: true, PARTNER: false, EQCR: false },
      approve: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: true, EQCR: false },
      eqcrReview: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: true },
    },
    workingPapers: {
      createWorkingPaper: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      editWorkingPaper: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      uploadEvidence: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      deleteEvidence: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: true, PARTNER: true, EQCR: false },
      viewLockedDocs: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: true },
      editLockedDocs: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: false },
    },
    aiFeatures: {
      useAIFieldAssist: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      aiRiskAssessment: { STAFF: false, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      aiAuditUtilities: { STAFF: false, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: false },
      aiCopilotAccess: { STAFF: true, SENIOR: true, TEAM_LEAD: true, MANAGER: true, PARTNER: true, EQCR: true },
    },
    administration: {
      manageUsers: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: false, FIRM_ADMIN: true, SUPER_ADMIN: true },
      manageFirmSettings: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: false, FIRM_ADMIN: true, SUPER_ADMIN: false },
      viewAuditLogs: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: true, PARTNER: true, EQCR: true, FIRM_ADMIN: true, SUPER_ADMIN: true },
      manageSubscriptions: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: false, FIRM_ADMIN: false, SUPER_ADMIN: true },
      platformConfig: { STAFF: false, SENIOR: false, TEAM_LEAD: false, MANAGER: false, PARTNER: false, EQCR: false, FIRM_ADMIN: false, SUPER_ADMIN: true },
    },
  },
  enforcementPoints: [
