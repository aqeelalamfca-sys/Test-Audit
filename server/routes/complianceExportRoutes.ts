...
const RBAC_MATRIX_DATA = {
  roleHierarchy: [
    ...
    { level: 3, role: "SENIOR", description: "Team lead, execution oversight" },
    { level: 4, role: "MANAGER", description: "Engagement manager, review authority" },
    { level: 5, role: "PARTNER", description: "Managing partner" },
    ...
    { level: 7, role: "FIRM_ADMIN", description: "Firm administrator" },
