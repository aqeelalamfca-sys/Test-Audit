...
const CLASSIFICATION_RULES: ClassificationRule[] = [
  ...
  // Property, Plant & Equipment (13xxx, 14xxx series)
  { pattern: /^1[34][0-9]{2,3}$/, accountClass: 'ASSET', accountSubclass: 'FIXED_ASSET', fsHeadKey: 'PPE', priority: 10 },
  ...
  // Non-current investments & other assets (15xxx series)
  { pattern: /^15[0-9]{2,3}$/, accountClass: 'ASSET', accountSubclass: 'NON_CURRENT_ASSET', fsHeadKey: 'INVESTMENTS', priority: 10 },
  ...
  // Long-term Liabilities (22xxx series)
  { pattern: /^22[0-9]{2,3}$/, accountClass: 'LIABILITY', accountSubclass: 'NON_CURRENT_LIABILITY', fsHeadKey: 'LONG_TERM_BORROWINGS', priority: 10 },
  // Other Current Liabilities (23xxx series)
  { pattern: /^23[0-9]{2,3}$/, accountClass: 'LIABILITY', accountSubclass: 'CURRENT_LIABILITY', fsHeadKey: 'OTHER_CURRENT_LIABILITIES', priority: 10 },
  ...
  // Other Expenses (54xxx series)
  { pattern: /^54[0-9]{2,3}$/, accountClass: 'EXPENSE', accountSubclass: 'OPERATING_EXPENSE', fsHeadKey: 'OTHER_EXPENSES', priority: 10 },
  ...
  // Finance Costs (55xxx, 60xxx series)
  { pattern: /^55[0-9]{2,3}$/, accountClass: 'EXPENSE', accountSubclass: 'FINANCE_COST', fsHeadKey: 'FINANCE_COSTS', priority: 10 },
  ...
  // Other Income (56xxx series)
  { pattern: /^56[0-9]{2,3}$/, accountClass: 'INCOME', accountSubclass: 'OTHER_INCOME', fsHeadKey: 'OTHER_INCOME', priority: 10 },
