...
type RoleKey = "ADMIN" | "PARTNER" | "EQCR" | "MANAGING_PARTNER" | "MANAGER" | "TEAM_LEAD" | "SENIOR" | "STAFF";
...
const rolePermissions: Record<RoleKey, string[]> = {
  ...
  PARTNER: [
    ...
    "QC_VIEW", "ISQM_VIEW", "INDEPENDENCE_REVIEW",
  ...
  MANAGING_PARTNER: [
    ...
    "EXECUTION_VIEW",
    "FINALIZATION_VIEW",
    "QC_VIEW", "ISQM_VIEW", "ISQM_MANAGE",
    "REPORT_VIEW", "PORTFOLIO_VIEW", "ANALYTICS_VIEW",
    "INDEPENDENCE_DECLARE",
  ],
  ...
  SENIOR: [
    ...
    "ENGAGEMENT_VIEW",
    "PLANNING_VIEW", "PLANNING_PREPARE",
    "EXECUTION_VIEW", "EXECUTION_PREPARE", "EXECUTION_INITIAL_REVIEW", "CONTROLS_TEST", "SUBSTANTIVE_TEST",
    "FINALIZATION_VIEW", "FINALIZATION_PREPARE",
    "QC_VIEW", "INDEPENDENCE_DECLARE",
    "REPORT_VIEW",
  ],
