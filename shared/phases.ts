...
export const CANONICAL_PHASES: CanonicalPhase[] = [
  {
    ...
    rolePermissions: { canPrepare: ALL_ROLES, canReview: SENIOR_UP, canApprove: MANAGER_UP, canReopen: MANAGER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
  ...
  },
  {
    ...
    rolePermissions: { canPrepare: SENIOR_UP, canReview: MANAGER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
  ...
  },
  {
    ...
    rolePermissions: { canPrepare: ALL_ROLES, canReview: MANAGER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
  ...
  },
  {
    ...
    description: "Document audit findings, internal control deficiencies, and management letter points per ISA 265/450",
    ...
    completionGates: [
      { id: "critical-findings-resolved", label: "Critical findings resolved", type: "hard", description: "All critical and high-severity findings must be resolved, cleared, or escalated", isaReference: "ISA 265" },
      { id: "management-responses-obtained", label: "Management responses obtained", type: "hard", description: "All observations requiring management response must have responses recorded", isaReference: "ISA 265" },
      { id: "review-notes-cleared", label: "Review notes cleared", type: "soft", description: "Open review notes should be addressed", isaReference: "ISA 220" },
      { id: "partner-review-observations", label: "Partner review complete", type: "soft", description: "Critical/high observations should be reviewed by partner", isaReference: "ISQM 1" },
    ],
    rolePermissions: { canPrepare: ALL_ROLES, canReview: MANAGER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
    aiCapabilities: ["observation-wording", "recommendation-wording", "management-letter-drafting"],
  ...
  },
  {
    ...
    group: "fieldwork",
    backendPhase: "EXECUTION",
    prerequisiteKeys: ["execution-testing", "observations"],
    requiredInputs: ["Proposed adjustments", "SAD schedule", "Management responses"],
    completionGates: [
      { id: "adjustments-summarized", label: "Adjustment summary prepared", type: "hard", description: "At least one adjustment must exist with corrected/uncorrected classification", isaReference: "ISA 450" },
      { id: "sad-classified", label: "SAD classified", type: "hard", description: "All uncorrected misstatements above trivial threshold must be classified (factual/judgmental/projected)", isaReference: "ISA 450" },
      { id: "management-acceptance-recorded", label: "Management acceptance recorded", type: "soft", description: "Management should confirm acceptance or dispute of each adjustment", isaReference: "ISA 450" },
      { id: "cumulative-effect-assessed", label: "Cumulative effect assessed", type: "soft", description: "Cumulative effect of uncorrected misstatements should be evaluated against materiality", isaReference: "ISA 450" },
    ],
    rolePermissions: { canPrepare: ALL_ROLES, canReview: MANAGER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
    aiCapabilities: ["misstatement-summary-drafting", "adjustment-narrative", "sad-summary-narration"],
    outputArtifacts: ["Adjustment schedule", "SAD summary", "Management representation items"],
  },
  {
    key: "finalization",
    label: "Finalization",
    description: "Complete all completion procedures including subsequent events review, going concern, representation letter, disclosure review, final analytics, and completion memo per ISA 560/570/580/450",
    ...
    requiredInputs: ["Completion checklist", "Subsequent events", "Going concern", "Representation letter", "Completion memo"],
    completionGates: [
      ...
      { id: "representation-letter", label: "Representation letter obtained", type: "hard", description: "Management representation letter must be obtained", isaReference: "ISA 580" },
      { id: "findings-addressed", label: "Findings & adjustments addressed", type: "hard", description: "All critical findings must be resolved and adjustment status must be finalized", isaReference: "ISA 450" },
      { id: "required-signoffs", label: "Required sign-offs obtained", type: "hard", description: "Manager and partner sign-offs must be obtained on key completion areas" },
      { id: "disclosure-reviewed", label: "Disclosure review complete", type: "soft", description: "Financial statement disclosures should be reviewed for completeness", isaReference: "ISA 700" },
      { id: "final-analytics-done", label: "Final analytical procedures done", type: "soft", description: "Final overall analytical review should be performed", isaReference: "ISA 520" },
      { id: "completion-memo-done", label: "Completion memo prepared", type: "hard", description: "Completion memo must be prepared summarizing the audit" },
      { id: "partner-review-ready", label: "Partner review readiness", type: "hard", description: "All completion procedures must be done before partner final review" },
    ],
    rolePermissions: { canPrepare: SENIOR_UP, canReview: MANAGER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
    aiCapabilities: ["completion-memo-drafting", "subsequent-events-narration", "going-concern-wording", "unresolved-matters-summary"],
    outputArtifacts: ["Completion memo", "Finalization checklist", "Representation letter"],
  },
  {
    key: "opinion-reports",
    label: "Opinion / Reports",
    description: "Form audit opinion, generate audit report, management letter, and deliverables pack per ISA 700/705/706/701/265",
    routeSlug: "opinion-reports",
    order: 16,
    group: "completion",
    backendPhase: "REPORTING",
    prerequisiteKeys: ["finalization"],
    requiredInputs: ["Opinion type", "Basis for opinion", "Report drafts", "Management letter", "Deliverables checklist"],
    completionGates: [
      ...
      { id: "basis-documented", label: "Basis for opinion documented", type: "hard", description: "Basis for opinion paragraph must be documented; for modified opinions, basis for modification is required", isaReference: "ISA 705" },
      { id: "kam-documented", label: "Key audit matters documented", type: "soft", description: "Key audit matters should be identified and communicated for listed entities", isaReference: "ISA 701" },
      { id: "fs-pack-ready", label: "Financial statement pack ready", type: "hard", description: "Complete financial statement pack must be assembled before report issuance" },
      { id: "management-letter-done", label: "Management letter prepared", type: "soft", description: "Management letter / internal control letter should be drafted for communication to TCWG", isaReference: "ISA 265" },
      { id: "deliverables-checklist-complete", label: "Deliverables checklist complete", type: "hard", description: "All required deliverables must be identified and tracked" },
      { id: "report-package-generated", label: "Report package generated", type: "soft", description: "Final report package should be generated and reviewed" },
      { id: "release-approved", label: "Release approved", type: "hard", description: "Partner must approve the final report package for release to the client" },
    ],
    rolePermissions: { canPrepare: MANAGER_UP, canReview: PARTNER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: ALL_ROLES },
    aiCapabilities: ["report-drafting-support", "basis-paragraph-support", "management-letter-wording", "deliverable-summary"],
    outputArtifacts: ["Audit report", "Management letter", "Deliverables pack", "Report package"],
  },
  {
    key: "eqcr",
    label: "EQCR Review",
    ...
    rolePermissions: { canPrepare: EQCR_ONLY, canReview: EQCR_ONLY, canApprove: EQCR_ONLY, canReopen: EQCR_ONLY, canArchive: PARTNER_UP, canView: MANAGER_UP },
  ...
  },
  {
    ...
    rolePermissions: { canPrepare: PARTNER_UP, canReview: PARTNER_UP, canApprove: PARTNER_UP, canReopen: PARTNER_UP, canArchive: PARTNER_UP, canView: MANAGER_UP },
